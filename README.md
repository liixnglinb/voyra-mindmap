# voyra-mindmap · AI Agent 思维导图

> Voyra 个人网站（https://lxlrwxs.top）的「AI Agent 思维导图」模块源码。
...
src/components/MindMapFrame.jsx
```
...
AI Agent 思维导图、mindmap、mind-map、ai、agent、react、react、vite
